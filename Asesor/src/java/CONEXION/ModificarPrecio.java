...
public class ModificarPrecio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String status = updateJuego(Long.parseLong(request.getParameter("precio_alquiler")), Integer.parseInt(request.getParameter("id_juego")));
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Modificar Precio " + status + "</h1>");
    ...
    private String updateJuego(long precioAlquiler, int idJuego) throws ClassNotFoundException_Exception {
        ...
        return port.updateJuego(precioAlquiler, idJuego);
    }
